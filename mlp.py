...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
   ...
   """
    ...
    theano.printing.pydotprint(test_model, outfile="test_model.png", var_with_name_simple=True)
    ...
    theano.printing.pydotprint(train_model, outfile="train_model.png", var_with_name_simple=True)
